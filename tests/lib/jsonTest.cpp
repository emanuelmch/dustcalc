...
void JsonTest::checkArray(const string &tag, const Json *json, unsigned long count, const char *name) {
    CPPUNIT_ASSERT_MESSAGE(tag + " should not be null", json != NULL);
...
void JsonTest::checkObject(const string &tag, const Json *json, unsigned long count, const char *name) {
    CPPUNIT_ASSERT_MESSAGE(tag + " should not be null", json != NULL);
